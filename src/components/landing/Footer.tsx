    ...
    <footer className="border-t border-border pt-10 pb-10 mt-5">
      <div className="max-w-[1180px] mx-auto px-7 flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="flex-1">
          <Link href="/" className="font-mono text-[14px] font-medium text-accent tracking-[0.06em] no-underline flex items-center gap-2 mb-4">
        ...
        <div className="flex gap-16">
          <div className="flex flex-col">
            ...
            <Link href="/duel" className="text-[13px] text-muted-2 py-1 transition-colors hover:text-text">Niche Duel ⚔️</Link>
          </div>
          <div className="flex flex-col">
            <h5 className="font-mono text-[11px] uppercase tracking-[0.1em] text-muted mb-3">Company</h5>
            <Link href="/dashboard" className="text-[13px] text-muted-2 py-1 transition-colors hover:text-text">Dashboard</Link>
            <Link href="/dashboard/settings" className="text-[13px] text-muted-2 py-1 transition-colors hover:text-text">Settings</Link>
          </div>
        </div>
      ...
      <div className="max-w-[1180px] mx-auto px-7 mt-5 pt-5 border-t border-border flex flex-col md:flex-row justify-between text-[11px] text-muted">
        <span>© {new Date().getFullYear()} ScopyAI. All rights reserved.</span>
